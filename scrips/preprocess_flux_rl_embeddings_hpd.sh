...
torchrun --nproc_per_node=8 --nnodes 1 --master_addr=127.0.0.1 --master_port=29502 \
    src/train_grpo_flux_base.py \
    --seed 42 \
    ...
    --data_json_path /root/autodl-tmp/DiffusionGRPO/data/rl_embeddings_hpd/txt2img.json \
