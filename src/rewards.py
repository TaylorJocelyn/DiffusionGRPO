...
MODEL_CKPT = {
    ...
    "aesthetic": {
        "open-clip": "/mnt/workspace/user/zengdawei.zdw/shared/jinghan.zq/DiffusionRL/models/hsp_v2/open_clip_pytorch_model.bin",
        "hps-v2d1": "/mnt/workspace/user/zengdawei.zdw/shared/jinghan.zq/DiffusionRL/models/hsp_v2/HPS_v2.1_compressed.pt"
    },
    "ecp": {
