...
def sample_reference_model(
    ...
    for index, batch_idx in enumerate(batch_indices):
        ...
        position_delta = position_delta[batch_idx]
    ...
    for reward_type in all_rewards:
        all_rewards[reward_type] = torch.cat(all_rewards[reward_type], dim=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_cache_dir", type=str, default="./cache_dir")
