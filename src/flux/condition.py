...
from .pipeline_tools import encode_images, encode_cond_images
...
class Condition(object):
    ...
    # An improved version using spatial mapping
    def map_encode(self, pipe: FluxPipeline, height: int, width:int, vae_scale_factor:float) -> Tuple[torch.Tensor, torch.Tensor, int]:
        """
        Encodes the condition into tokens, ids and type_id.
        """
        if self.condition_type in [
